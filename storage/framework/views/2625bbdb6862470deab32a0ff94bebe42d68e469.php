                         ...
                         <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2" 
                            ...
                            <div class="row form-row">
                            	<div class="parsley-input col-md-6" >
	                                ...
	                                <select class="select" name="patientId[]" multiple data-mdb-filter="true">
							...
							<div class="row form-row">
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="patientId[]" multiple id="select-beast" class="form-control  nice-select  custom-select">
                                         <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									  	<option value="<?php echo e($_item->device_token); ?>">
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/template-rt/resources/views/admin/sendnotification/patient.blade.php ENDPATH**/ ?>