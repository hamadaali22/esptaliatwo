							...
							<div class="row form-row">
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="doctorId[]" multiple id="select-beast" class="form-control  nice-select  custom-select">
                                         <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									  	<option value="<?php echo e($_item->device_token); ?>">
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/template-rt/resources/views/admin/sendnotification/doctors.blade.php ENDPATH**/ ?>